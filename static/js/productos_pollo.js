/* ============================================
   PRODUCTOS DE POLLO
   Carga dinámica de productos de carne de pollo
   ============================================ */

// --- Cargar productos de categoría 3 (Carne de Pollo) ---
...
async function cargarProductos() {
    try {
        const response = await fetch('/api/productos/categoria/3');
    ...
    const html = productos.map(prod => `
        <div class="bg-white rounded-xl shadow-lg overflow-hidden product-card">
            ...
            <div class="p-5 text-center">
                ...
                <p class="text-2xl font-extrabold text-yellow-600 mb-2">
