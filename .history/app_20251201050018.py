...
def get_productos():
    ...
    try:
        ...
        for p in productos:
            ...
            # Validar que la imagen exista, si no usar placeholder
        imagen_url = p[5] if p[5] else ""
        
        # Si hay imagen, verificar que sea una URL válida o un nombre de archivo
        if imagen_url and not imagen_url.startswith(('http', '/')):
            # Es un nombre de archivo, agregarle el prefijo
            imagen_url = imagen_url
        elif not imagen_url:
            # Sin imagen, dejamos vacío para que use placeholder
            imagen_url = ""
